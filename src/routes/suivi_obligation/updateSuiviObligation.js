  ...
  app.put(
    ...
    async (req, res) => {
      ...
      try {
        ...
        const { etat_conformite, date_suivi, commentaire, fichier_joint } =
          req.body;

        await models.suivi_obligation.update(req.body, {
          where: { id_suivi: id },
        });

        const updatedSuiviObligation = await models.suivi_obligation.findByPk(
          id
        );
        ...
        const message =
          "Une erreur est survenue lors de la modification du suivi d'obligation";
