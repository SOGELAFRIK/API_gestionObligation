...
module.exports = (app) => {
    app.get("/api/obligation", auth, async (req, res) => {
        try {
            ...
            const obligation = await models.obligation.findAll({ order: ["id_obligation"] });
            ...
            const message = "Une erreur est survenue lors de la récupération de la liste des obligations";
