...
module.exports = (app) => {
  app.put("/api/periodicite/:id", auth(1, getUserRole), async (req, res) => {
    const { id } = req.params;
    ...
    try {
      ...
      await models.periodicite.update(req.body, {
      ...
      const message =
        "Une erreur est survenue lors de la modification de La periodicite";
