...
module.exports = (app) => {
  app.put("/api/risqueLevel/:id", auth(1, getUserRole), async (req, res) => {
    const { id } = req.params;
    ...
    try {
      ...
      await models.niveau_risque.update(req.body, {
        where: { id_niveau_risque: id },
      });
      ...
      const message =
        "Une erreur est survenue lors de la modification du risqueLevel";
