...
module.exports = (app) => {
  app.put("/api/consolidation/:id", auth(1, getUserRole), async (req, res) => {
    const { id } = req.params;
    ...
    try {
      ...
      await models.consolidation.update(
        {
          nb_obligations,
          nb_obligations_conformes,
          nb_obligations_non_conformes,
      ...
      const message =
        "Une erreur est survenue lors de la modification da la consolidation";
