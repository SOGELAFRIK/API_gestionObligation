...
module.exports = (app) => {
  app.put('/api/texte/:id', auth, async (req, res) => {
    ...
    try {
      ...
      await models.texte.update({ corps_texte }, { where: { id_texte: id } });
      ...
      const message = "Une erreur est survenue lors de la modification du texte";
